 ...
 */
public class NIVInspectionTest extends LightJavaCodeInsightFixtureTestCase {
  ...
  protected void doTest(@NotNull String testName) {
    ...
    myFixture.enableInspections(new NIVSolver());
    List<HighlightInfo> highlightInfos = myFixture.doHighlighting();
    assertFalse(highlightInfos.isEmpty());
    // Get the quick fix action for comparing references inspection and apply it to the file
    final IntentionAction action = myFixture.findSingleIntention(NIVSolver.QUICK_FIX_NAME);
